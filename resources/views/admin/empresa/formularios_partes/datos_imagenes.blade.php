...
<div class="formulario-label-fiel">
{!! Form::label('imagen_contacto', 'Imagen de contacto', array('class' => 'formulario-label ')) !!}
{!! Form::file('imagen_contacto',['class' => 'formulario-field']) !!}   
</div>
...
@if($Empresa->img_atencion != null)
 <div class="contiene-img-y-nombre">
   <div class="formulario-label">Imagen de contacto</div>
   <img class="admin-empresa-img-corporativas" src="{{$Empresa->img_atencion}}">
 </div>
@endif
